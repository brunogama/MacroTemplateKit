...
final class IdentifierEscapingTests: XCTestCase {
  ...
  func testVariableReference_reservedKeyword_isEscaped() {
    var buffer = ""
  ...
  func testVariableReference_reservedKeyword_parsesCleanly() {
    let rendered = Renderer.render(Template<Void>.variable("class", payload: ()))
  ...
  func testPropertyAccessBase_reservedKeyword_isEscaped() {
  ...
  func testVariableReference_selfAndSuper_areNotEscaped() {
  ...
  func testContextualKeywords_areNotEscaped() {
  ...
  func testOrdinaryIdentifier_isUnchanged() {
    var buffer = ""
  ...
  func testAlreadyBacktickedIdentifier_isNotDoubleEscaped() {
