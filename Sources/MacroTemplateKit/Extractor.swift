...
public enum Extractor {
    ...
    private static func extractAttributes(
        ...
        attributeList.compactMap { element -> AttributeSignature? in
            ...
            switch arguments {
            case let .argumentList(labeledExprs):
            ...
            case let .availability(availArgs):
    ...
    private static func extractAvailabilityArgument(
        ...
        case let .availabilityVersionRestriction(platformVersion):
        ...
        case let .availabilityLabeledArgument(labeled):
            ...
            case let .string(stringLiteral):
                let text = stringLiteral.segments.trimmedDescription
                value = .string(text)
            case let .version(versionTuple):
